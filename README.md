...
| `DESIGN.md` / `PRODUCT.md` | Visual system and product intent |
...
Visual language is Apple Continuity / Screen Mirroring on Windows: dark field, frosted plate, SF-style type stack with Segoe fallbacks. Tokens and component rules live in `DESIGN.md`. Product principles live in `PRODUCT.md`.
