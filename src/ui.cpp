/* THESIS: The window is a Continuity plate — full-bleed glass, the receiver name is the object.
 * OWN-WORLD: #1d1d1f field, #2c2c2e plate, SF/Segoe Variable, outlined capsules, blue only when on.
 * STORY: iPhone finds this name. The pill and status line say the state. PIN takes the plate.
 * FIRST VIEWPORT: Thin margin, near-full glass, wordmark left, Waiting pill right, giant name, four floor capsules.
 * FORM: Continuity Card / full-bleed glass. Seed 39aa8d6f.
 * CRAFT: near-black field, floating frosted plate, hero name, recessed capsules. */
